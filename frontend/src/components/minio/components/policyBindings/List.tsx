...
export function PolicyBindingsList() {
  ...
  return isMinioInstalled ? (
    <ResourceListView
      title="MinIO Policy Bindings"
      resourceClass={PolicyBinding}
      columns={[
        'name',
        'namespace',
        {
          ...
          getValue: item => item.serviceAccount,
        },
        {
          id: 'saNamespace',
          label: 'SA Namespace',
          getValue: item => item.serviceAccountNamespace,
        },
        {
          id: 'policies',
          label: 'Policies',
          getValue: item => item.policies.join(', '),
        },
        'age',
      ]}
    />
